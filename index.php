...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="<?php echo Api_url; ?>auth/login" method="post" id="loginForm">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Enter Username" id="name" name="name" value="admin" required>

      <label for="psw"><b>Password</b></label>
      <input type="password" placeholder="Enter Password" id="pwd" name="password" value="123123" required>
...
$("#loginForm").submit(function(event){
	...
	var form_data = JSON.stringify( { "user":{"name": $('#name').val(), "password": $('#pwd').val() }} );
